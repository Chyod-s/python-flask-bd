...
from src.utils.auth_util import check_email, check_password
from src.infraestructure.handler.jwt_handler import generate_token
from src.utils.exceptions import CustomAPIException
from src.domain.models.users_model import User
